...
export default function MessagesScreen() {
  ...
  const [availableUsers] = useState([
    { id: 'user1', name: 'Jean Dupont', city: 'Yaoundé', avatar: 'https://via.placeholder.com/50' },
    { id: 'user2', name: 'Marie Martin', city: 'Douala', avatar: 'https://via.placeholder.com/50' },
    { id: 'user3', name: 'Pierre Nkoulou', city: 'Yaoundé', avatar: 'https://via.placeholder.com/50' },
    { id: 'user4', name: 'Sophie Mbarga', city: 'Bafoussam', avatar: 'https://via.placeholder.com/50' },
    { id: 'user5', name: 'Paul Etoa', city: 'Douala', avatar: 'https://via.placeholder.com/50' },
  ]);
  ...
  const [messages, setMessages] = useState<Message[]>([
    ...
    },
    {
      id: '3',
      sender: 'Jean Dupont',
      content: 'Parfait, je voulais discuter du planning de la semaine',
      timestamp: '10:33',
      isOwn: false,
      type: 'text',
    },
